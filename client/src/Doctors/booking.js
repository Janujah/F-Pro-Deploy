...
//         //     fetch('https://f-pro-deploy-backend.vercel.app/consult/create', {
//         //         method: 'POST',
//         //         headers: { 'Content-Type': 'application/json' },
    ...
    const handleToken = async (token) => {
        try {
          ...
          if (response.ok) {
            ...
            const addToDashboardResponse = await fetch('https://f-pro-deploy-backend.vercel.app/booking/payment/success', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
...
//       try {
//         const response = await fetch('https://f-pro-deploy-backend.vercel.app/bookings', {
//           method: 'POST',
//           headers: {
...
//   const handleToken = async (token) => {
//     try {
//       const response = await fetch('https://f-pro-deploy-backend.vercel.app/charge', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json'
//         },
...
//   const handleToken = async (token) => {
//     try {
//       const response = await fetch('https://f-pro-deploy-backend.vercel.app/bookings/payment', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//     fetch('https://f-pro-deploy-backend.vercel.app/bookings/add', {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json',
//       },
